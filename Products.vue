		...
		<b-row>
			<b-col cols="3" v-for="(fruit, index) in fruits" :key="index">
				...
				>
					...
					<b-button v-if="fruit.cart" :disabled="fruit.cart" block href="#" variant="warning">Already added to cart</b-b-button>
				</b-card>
			</b-col>
...
export default {
			...
			fruits: [
				{
					...
					name: 'Apple',
					price:1,
					img: '@/assets/img/fruits/fruit1.jpg',
					cart:false
				},
				{
					id:2,
	...
	created(){
		...
		for (let index = 0; index < cart.length; index++) {
			for (let index2 = 0; index2 < cart.length; index2++){
