...
export default {
  ...
  //composition api
  setup() {
	  app.messaging().getToken({ vapidKey:  'BDhrzaY6bmW70cF6SRf9jeTqB4zpQTByoQ05NABTplyexZ2ot5TXKhMtB_EIpXzQftin2ybfAHImBm_LJ3HAJOs' })
.then((currentToken) => {
  if (currentToken) {
  ...
  console.log('An error occurred while retrieving token. ', err);
	...
	messaging.getToken({ vapidKey:'BDhrzaY6bmW70cF6SRf9jeTqB4zpQTByoQ05NABTplyexZ2ot5TXKhMtB_EIpXzQftin2ybfAHImBm_LJ3HAJOs' })
